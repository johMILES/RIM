...
void NewClientNodePrivate::initView()
{
    ...
    nodeLabel->setText(tr("Node id"));

    nodeEdit = new QLineEdit;

    //ip
    QLabel * commLabel = new QLabel;
    commLabel->setText(tr("Communication method"));

    commEdit = new QLineEdit;

    //format
    QLabel * formatLabel = new QLabel;
    formatLabel->setText(tr("Message format"));
    ...
    distLabel->setText(tr("Distribute message type"));
