...
void RouteSettings::initSettings(ParameterSettings::RouteSetting *setts)
{
    if(!setts)
        return;
...
ParameterSettings::RouteSetting *RouteSettings::settings()
{
    return rsettings;
}
...
void RouteSettings::copy(ParameterSettings::RouteSetting *setts)
{
    if(rsettings == NULL){
        rsettings = new ParameterSettings::RouteSetting;
