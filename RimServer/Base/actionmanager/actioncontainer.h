...
struct BASESHARED_EXPORT Group
{
...
class ActionContainerProxy : public ActionContainer
{
    Q_OBJECT
public:
...
class MenuActionContainer : public ActionContainerProxy
{
public:
...
class MenuBarActionContainer : public ActionContainerProxy
{
public:
