 ...
 *  @brief 网络协议头
 */
class BASESHARED_EXPORT MsgPacket
{
public:
    MsgPacket();
    virtual ~MsgPacket();
 ...
 *  @brief  注册个人账户请求
 */
class BASESHARED_EXPORT RegistRequest : public MsgPacket
{
public:
    RegistRequest();
 ...
 *  @brief  注册个人账户响应
 */
class BASESHARED_EXPORT RegistResponse : public MsgPacket
{
public:
    RegistResponse();
 ...
 *  @brief  登陆请求
 */
class BASESHARED_EXPORT LoginRequest : public MsgPacket
{
public:
    LoginRequest();
 ...
 *  @brief  登陆响应
 */
class BASESHARED_EXPORT LoginResponse : public MsgPacket
{
public:
    LoginResponse();
    LoginType loginType;            /*!< 登陆类型 */
 ...
 *  @brief  更新基本信息请求
 */
class BASESHARED_EXPORT UpdateBaseInfoRequest : public MsgPacket
{
public:
 ...
 *  @brief  基本信息响应
 */
class BASESHARED_EXPORT UpdateBaseInfoResponse : public MsgPacket
{
public:
 ...
 *  @brief  查找好友请求
 */
class BASESHARED_EXPORT SearchFriendRequest : public MsgPacket
{
public:
    SearchFriendRequest();
 ...
 *  @details 返回查找的结果列表
 */
class BASESHARED_EXPORT SearchFriendResponse : public MsgPacket
{
public:
 ...
 */
class BASESHARED_EXPORT AddFriendRequest : public MsgPacket
{
public:
    AddFriendRequest();
 ...
 */
class BASESHARED_EXPORT AddFriendResponse : public MsgPacket
{
public:
    AddFriendResponse();
};
 ...
 */
class BASESHARED_EXPORT OperateFriendRequest : public MsgPacket
{
public:
 ...
 *  @details 依据 @link SearchType @endlink 类型发送请求操作。
 */
class BASESHARED_EXPORT OperateFriendResponse : public MsgPacket
{
public:
 ...
 */
class BASESHARED_EXPORT FriendListRequest : public MsgPacket
{
public:
    FriendListRequest();
 ...
 *  @brief 好友列表结果
 */
class BASESHARED_EXPORT FriendListResponse : public MsgPacket
{
public:
    FriendListResponse();
    ~FriendListResponse();
 ...
 */
class BASESHARED_EXPORT GroupingFriendRequest : public MsgPacket
{
public:
 ...
 *  @brief  联系人分组操作响应
 */
class BASESHARED_EXPORT GroupingFriendResponse : public MsgPacket
{
public:
 ...
 *  @brief 分组操作请求
 */
class BASESHARED_EXPORT GroupingRequest : public MsgPacket
{
public:
    GroupingRequest();
 ...
 *  @brief 分组操作响应
 */
class BASESHARED_EXPORT GroupingResponse : public MsgPacket
{
public:
    GroupingResponse();
    QString uuid;             /*!< 联系人uuid */
 ...
 */
class BASESHARED_EXPORT UserStateRequest : public MsgPacket
{
public:
    UserStateRequest();
    QString accountId;              /*!< 用户账号 */
 ...
 *           2.用于接收朋友状态变更通知 @n
 */
class BASESHARED_EXPORT UserStateResponse : public MsgPacket
{
public:
    UserStateResponse();
 ...
 */
class BASESHARED_EXPORT HistoryMessRequest : public MsgPacket
{
public:
    HistoryMessRequest();
    QString accountId;              /*!< 用户账号 */
 ...
 */
class BASESHARED_EXPORT ChatGroupListRequest : public MsgPacket
{
public:
 ...
 *  @brief 群列表结果
 */
class BASESHARED_EXPORT ChatGroupListResponse : public MsgPacket
{
public:
 ...
 *  @brief  注册群账户请求
 */
class BASESHARED_EXPORT RegistGroupRequest : public MsgPacket
{
public:
    RegistGroupRequest();
 ...
 *  @brief  注册群账户响应
 */
class BASESHARED_EXPORT RegistGroupResponse : public MsgPacket
{
public:
    RegistGroupResponse();
    QString userId;             /*!< 用户uuid */
 ...
 */
class BASESHARED_EXPORT SearchGroupResponse : public MsgPacket
{
public:
    SearchGroupResponse();
 ...
 *  @brief  群分组操作请求
 */
class BASESHARED_EXPORT GroupingChatRequest : public MsgPacket
{
public:
    GroupingChatRequest();
 ...
 *  @brief  群分组操作响应
 */
class BASESHARED_EXPORT GroupingChatResponse : public MsgPacket
{
public:
 ...
 *  @brief  群命令操作请求
 */
class BASESHARED_EXPORT GroupingCommandRequest : public MsgPacket
{
public:
 ...
 *  @brief  群命令操作响应
 */
class BASESHARED_EXPORT GroupingCommandResponse : public MsgPacket
{
public:
...
*/
class BASESHARED_EXPORT TextRequest : public MsgPacket
{
public:
    TextRequest();
 ...
 *  @brief 消息确认
 */
class BASESHARED_EXPORT TextReply : public MsgPacket
{
public:
    TextReply();
    QString textId;             /*!< 消息唯一标识 */
 ...
 */
class BASESHARED_EXPORT FileItemRequest : public MsgPacket
{
public:
    FileItemRequest();
 ...
 * @brief 文件数据传输请求
 */
class BASESHARED_EXPORT FileDataRequest : public MsgPacket
{
public:
    FileDataRequest();
    FileTransferControl control;    /*!< 传输控制命令 @link FileTransferControl @endlink */
 ...
 */
class BASESHARED_EXPORT SimpleFileItemRequest : public MsgPacket
{
public:
 ...
 *  @brief 阐述传输块
 */
class  BASESHARED_EXPORT FileDataTrunkRequest : public MsgPacket
{
public:
