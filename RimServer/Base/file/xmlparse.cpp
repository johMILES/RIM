 ...
 * @return 是否解析成功
 */
bool XMLParse::parseRouteSettings(const QString &fileName, ParameterSettings::RouteSetting *routeSettings)
{
    QDomDocument document("document");
    if(!validateParseFile(fileName,document))
        return false;
 ...
 */
bool XMLParse::saveRouteSettings(const QString &fileName, ParameterSettings::RouteSetting *routeSettings)
{
    RouteDom routeDom;
