 ...
 */
class BASESHARED_EXPORT RGroup
{
public:
    RGroup();
    const QString table;
 ...
 */
class BASESHARED_EXPORT RGroupDesc
{
public:
    RGroupDesc();
    const QString table;
...
*/
class BASESHARED_EXPORT RGroup_User
{
public:
    RGroup_User();
    const QString table;
 ...
 */
class BASESHARED_EXPORT RChatRoom
{
public:
    RChatRoom();
    const QString table;
 ...
 *  @details 用户群分组表
 */
class BASESHARED_EXPORT RChatGroup
{
public:
    RChatGroup();
    const QString table;
 ...
 */
class BASESHARED_EXPORT RChatGroupDesc
{
public:
    RChatGroupDesc();
    const QString table;
 ...
 */
class BASESHARED_EXPORT RChatGroupRoom
{
public:
    RChatGroupRoom();
    const QString table;
 ...
 */
class BASESHARED_EXPORT RChatroom_User
{
public:
    RChatroom_User();
    const QString table;
...
//请求缓存表
class BASESHARED_EXPORT RequestCache
{
public:
    RequestCache();
    const QString table;
...
//用户聊天信息表
class BASESHARED_EXPORT RUserChatCache
{
public:
    RUserChatCache();
    const QString table;
 ...
 *  @brief  716离线信息记录结构
 */
class BASESHARED_EXPORT RChat716Cache
{
public:
    RChat716Cache();
    const QString table;
 ...
 */
class BASESHARED_EXPORT RFile716
{
public:
    RFile716();
    const QString table;
 ...
 */
class BASESHARED_EXPORT RFile716Cache
{
public:
    RFile716Cache();
    const QString table;
